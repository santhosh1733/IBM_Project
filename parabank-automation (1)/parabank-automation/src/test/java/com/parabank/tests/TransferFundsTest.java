...
public class TransferFundsTest extends BaseTest {
    ...
    @Test(description = "TC-01 Verify successful transfer between two valid accounts")
    public void verifySuccessfulTransferBetweenTwoValidAccounts() {
        ...
        // Return to Accounts Overview via the TransferFunds page navigation so the Overview is fully loaded
        ...
        pass("Step 5 Passed: Balance verification successful. From Account: $" + String.format("%.2f", fromBalanceAfter)
                + " (was $" + String.format("%.2f", fromBalanceBefore) + "), To Account: $" + String.format("%.2f", toBalanceAfter)
                + " (was $" + String.format("%.2f", toBalanceBefore) + ").");
    }
    ...
    public void verifySourceAccountBalanceDecreasesAfterTransfer() {
        ...
        pass("Step 3 Passed: Source Account (" + fromAccount + ") Balance Before = $" + String.format("%.2f", sourceBalanceBefore));

        // Choose a small transfer amount that is guaranteed to be <= sourceBalanceBefore
        ...
        // Step 6: Verify source account balance decreased by exactly the transferred amount
        ...
        pass("Step 6 Passed: Source Account Balance Verification successful. "
                + "Before: $" + String.format("%.2f", sourceBalanceBefore)
                + " → After: $" + String.format("%.2f", sourceBalanceAfter)
    ...
    public void verifyDestinationAccountBalanceIncreasesAfterTransfer() {
        ...
        pass("Step 3 Passed: Destination Account (" + toAccount + ") Balance Before = $" + String.format("%.2f", destinationBalanceBefore));
        ...
        // Step 6: Verify destination account balance increased by exactly the transferred amount
        ...
        pass("Step 6 Passed: Destination Account Balance Verification successful. "
                + "Before: $" + String.format("%.2f", destinationBalanceBefore)
                + " → After: $" + String.format("%.2f", destinationBalanceAfter)
                + " (Increased by: $" + transferAmountStr + ")");
    }
    ...
    public void verifyTransferConfirmationDisplaysCorrectDetails() {
        ...
        Assert.assertEquals(confirmedAmount, expectedAmount,
                "Confirmed transfer amount does not match requested amount. Expected: " + expectedAmount 
        ...
        pass("Step 7 Passed: All transfer confirmation details are complete and correct. "
                + "Transfer Amount: " + confirmedAmount + ", From Account: " + fromAccount 
    ...
    public void verifyTransferAmountGreaterThanAvailableBalance() {
        ...
        pass("Step 4 Passed: Transfer amount calculated = $" + excessiveTransferAmountStr + " (Exceeds available balance by $100.00)");

        // Step 5: Navigate to Transfer Funds and attempt transfer with excessive amount
        info("Step 5: Navigate to Transfer Funds page and attempt transfer with excessive amount. From Account: " + fromAccount 
                + ", To Account: " + toAccount + ", Amount: $" + excessiveTransferAmountStr);
        TransferFundsPage transferPage = overview.goToTransferFunds();
        ...
        // Step 7: Verify we are still on Transfer Funds page (not on success confirmation)
        ...
        pass("Step 7 Passed: Excessive transfer rejection verified. System correctly prevented transfer of $" 
                + excessiveTransferAmountStr + " from account with balance of only $" + String.format("%.2f", sourceBalance));
    }
    ...
    public void verifyTransferWithZeroAmount() {
        ...
        info("Step 4: Navigate to Transfer Funds page and attempt transfer with zero amount. From Account: " + fromAccount 
                + ", To Account: " + toAccount + ", Amount: $" + zeroTransferAmount);
        TransferFundsPage transferPage = overview.goToTransferFunds();
        ...
        pass("Step 6 Passed: System correctly prevented zero amount transfer. "
                + "Transfer of $" + zeroTransferAmount + " from account " + fromAccount 
                + " to account " + toAccount + " was rejected.");
    }
    ...
    public void verifyTransferWithNegativeAmount() {
        ...
        info("Step 4: Navigate to Transfer Funds page and attempt transfer with negative amount. From Account: " + fromAccount 
                + ", To Account: " + toAccount + ", Amount: $" + negativeTransferAmount);
        TransferFundsPage transferPage = overview.goToTransferFunds();
        ...
        pass("Step 6 Passed: System correctly prevented negative amount transfer. "
                + "Transfer of $" + negativeTransferAmount + " from account " + fromAccount 
                + " to account " + toAccount + " was rejected due to invalid amount.");
    }
    ...
    public void verifyTransferWithNonNumericAmount() {
        ...
        // Step 4: Navigate to Transfer Funds and attempt transfer with non-numeric amount
        info("Step 4: Navigate to Transfer Funds page and attempt transfer with non-numeric amount. From Account: " + fromAccount 
                + ", To Account: " + toAccount + ", Amount: \"" + nonNumericTransferAmount + "\"");
        TransferFundsPage transferPage = overview.goToTransferFunds();
        ...
        pass("Step 6 Passed: System correctly prevented non-numeric amount transfer. "
                + "Transfer with amount \"" + nonNumericTransferAmount + "\" from account " + fromAccount 
                + " to account " + toAccount + " was rejected due to invalid input format.");
    }
    ...
    public void verifyTransferWithEmptyAmount() {
        ...
        info("Step 4: Navigate to Transfer Funds page and attempt transfer with empty amount. From Account: " + fromAccount 
                + ", To Account: " + toAccount + ", Amount: (empty/blank)");
        TransferFundsPage transferPage = overview.goToTransferFunds();
        ...
        pass("Step 6 Passed: System correctly prevented empty amount transfer. "
                + "Transfer with blank/empty amount from account " + fromAccount 
                + " to account " + toAccount + " was rejected due to missing required field.");
    }
    ...
    public void verifyTransferWithoutSelectingFromAccount() {
        ...
        // Step 6: Verify system validation prevents transfers without From Account selection
        ...
        pass("Step 6 Passed: System correctly prevented transfer without From Account. "
                + "Transfer to account " + toAccount + " of $" + transferAmount 
    ...
    public void verifyTransferWithoutSelectingToAccount() {
        ...
        // Step 6: Verify system validation prevents transfers without To Account selection
        ...
        pass("Step 6 Passed: System correctly prevented transfer without To Account. "
                + "Transfer from account " + fromAccount + " of $" + transferAmount 
    ...
    public void verifyTransferBetweenSameFromAndToAccount() {
        ...
        info("Step 4: Navigate to Transfer Funds page and attempt transfer FROM and TO the same account. "
                + "Account: " + sameAccount + ", Amount: $" + transferAmount);
        TransferFundsPage transferPage = overview.goToTransferFunds();
        ...
        pass("Step 6 Passed: System correctly prevented transfer between same account. "
                + "Transfer from account " + sameAccount + " to the same account " + sameAccount 
                + " of $" + transferAmount + " was rejected due to invalid transfer operation.");
    }
    ...
    public void verifySourceAndDestinationBalancesUpdatedAfterTransfer() {
        ...
        info("Step 4: Perform transfer of $" + transferAmountStr + " from account " + fromAccount 
                + " to account " + toAccount);
        TransferFundsPage transferPage = overview.goToTransferFunds();
        transferPage.transfer(transferAmountStr, fromAccount, toAccount);
    ...
    public void verifySuccessfulTransferReflectedInTransactionHistory() {
        ...
        info("Step 3: Perform transfer of $" + transferAmountStr + " from account " + fromAccount 
                + " to account " + toAccount);
        TransferFundsPage transferPage = overview.goToTransferFunds();
        transferPage.transfer(transferAmountStr, fromAccount, toAccount);
    ...
    public void verifyRapidMultipleClicksDoNotCreateDuplicateTransactions() {
        ...
        pass("Step 3 Passed: Transfer form filled with: From=" + fromAccount + ", To=" + toAccount 
